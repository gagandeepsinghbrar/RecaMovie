...
class Database() {
        ...
        val MattAWSAccessKeyId = "<<ACCESS KEY>>"
        val MattAWSSecretKey = "<<SECRET KEY>>"
        ...
        */
        def loadRatings() = {
                ...
                val jdbcDatabase = "masterdb"
                val jdbcPort = 3306
                val jdbcHostname = "<<DYNAMODB URL>>"
        ...
        */
        ...
        def pushRecommendations(recommendations:Seq[String], userId:Integer) = {
                ...
                val table: Table = dynamoDB.table("<<DYNAMODB TABLE>>").get
